...
from omni.isaac.lab_assets.luna import LUNA_CFG
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        ranges=mdp.UniformVelocityCommandCfg.Ranges(
            lin_vel_x=(-0.8, 0.8), lin_vel_y=(-0.8, 0.8), ang_vel_z=(-0.8, 0.8), heading=(-math.pi, math.pi)
        ),
    )
...
class ActionsCfg:
    ...
    joint_eff = mdp.JointPositionActionCfg(asset_name="robot", joint_names=['BL_shoulder_joint', 'BR_shoulder_joint', 'FL_shoulder_joint', 'FR_shoulder_joint', 'BL_hip_joint', 'BR_hip_joint',
                             'FL_hip_joint', 'FR_hip_joint', 'BL_knee_joint', 'BR_knee_joint', 'FL_knee_joint', 'FR_knee_joint'], scale=1.0)
...
@configclass
class LunaFlatEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class LunaFlatEnvCfg_PLAY(LunaFlatEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class LunaRoughEnvCfg(LunaFlatEnvCfg):
...
@configclass
class LunaRoughEnvCfg_PLAY(LunaFlatEnvCfg_PLAY):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        self.scene.terrain.terrain_type = "generator"
